...
1. Accede a `http://localhost:8069` en tu navegador.
    ![Acceso localhost](../assets/img/08-creacion_bd_prueba/01_acceso-localhost.png)
2. Crea una **base de datos nueva** (admin email y contraseña).
    ![Crear database](../assets/img/08-creacion_bd_prueba/02_crear-database.png)
3. Elige módulos iniciales si procede.
    ![Módulos iniciales](../assets/img/08-creacion_bd_prueba/03_modulos-iniciales.png)
